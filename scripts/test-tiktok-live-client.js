...
// Prueba de integracion AISLADA del nuevo @tiklivetts/tiktok-live-client
// dentro del mismo runtime de Electron que usa la app real (mismo
// package.json, misma version de Electron) — NO toca el flujo de
// produccion (features/canales/tiktok/ sigue usando tiktok-live-connector).
...
async function main() {
  ...
  client.on('error', (err) => console.error('[tiktok-live-client test] ERROR', err.message));
