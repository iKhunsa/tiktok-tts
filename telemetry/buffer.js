...
// Cola de eventos con respaldo en disco.
//
// Si el servidor de telemetria esta caido, los eventos no se pierden: quedan
// en un archivo del directorio de datos y se reenvian en el siguiente arranque.
// El archivo esta acotado para que un servidor caido durante semanas no
// engorde el disco del usuario.
...
class Buffer {
  ...
  persist() {
    ...
    } catch (_) { /* disco lleno o sin permisos: se sigue en memoria */ }
  }
